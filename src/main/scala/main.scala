...
import assignment3.SmartAlarmSystem.Command.{EnterPin, EnterTimer, SensorDetection}
...
def main(): Unit =
  ...
  system ! SensorDetection("Hall")
  Thread.sleep(1000)

  system ! EnterPin("222")
  Thread.sleep(1000)

  system ! EnterPin("1234")// exit house arming (timer started)
  system ! EnterPin("1234")//disarmed immediately
  system ! EnterPin("1234")//rearmed
  Thread.sleep(1200)

  system ! SensorDetection("Hall")

  system ! EnterPin("222")// typo in pin
  system ! EnterPin("1234")// correct pin

  Thread.sleep(500)

  system ! EnterPin("1234") //exit again
  Thread.sleep(1500) //system armed

  system ! SensorDetection("Hall")
  Thread.sleep(2000)
  system ! EnterPin("222") //should not nino
